...
parser.add_argument("--vid_list_file", default="./data/split1.train")
parser.add_argument("--model_save_path", default="./save_dir/results/rnn1")
parser.add_argument("--results_save_path", default="./save_dir/results/rnn1")
