...
for line in f:
      ...
      if(line[0]=="END"):
         print_measure(vectObs,vectAcc,vectAT,vectRT,vectPC)
         vectObs = np.zeros(16)
         vectAcc = np.zeros(16)
         vectAT = np.zeros(16)
         vectRT = np.zeros(16)
