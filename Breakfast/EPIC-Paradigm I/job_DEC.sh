...
#python3 main.py --model=rnn --action=train --vid_list_file=./data/train.split1.bundle  --model_save_path=./save_dir/models/rnn1 --results_save_path=./save_dir/results/rnn1 --decoded_path=./data/decoded/split1
#python3 main.py --model=rnn --action=predict  --vid_list_file=./data/test.split1.bundle --model_save_path=./save_dir/models/rnn1 --results_save_path=./save_dir/results/rnn1 --decoded_path=./data/decoded/split1 
...
#python3 main.py --model=cnn --action=train --vid_list_file=./data/train.split1.bundle --model_save_path=./save_dir/models/cnn1 --results_save_path=./save_dir/results/cnn1 --batch_size=64  --decoded_path=./data/decoded/split1 
#python3 main.py --model=cnn --action=predict --vid_list_file=./data/test.split1.bundle  --model_save_path=./save_dir/models/cnn1 --results_save_path=./save_dir/results/cnn1 --batch_size=64 --decoded_path=./data/decoded/split1
...
#python3 main.py --model=rnn --action=train --vid_list_file=./data/train.split2.bundle  --model_save_path=./save_dir/models/rnn2 --results_save_path=./save_dir/results/rnn2 --decoded_path=./data/decoded/split2 
#python3 main.py --model=rnn --action=predict  --vid_list_file=./data/test.split2.bundle  --model_save_path=./save_dir/models/rnn2 --results_save_path=./save_dir/results/rnn2 --decoded_path=./data/decoded/split2 
...
#python3 main.py --model=cnn --action=train --vid_list_file=./data/train.split2.bundle --model_save_path=./save_dir/models/cnn2 --results_save_path=./save_dir/results/cnn2 --batch_size=64 --decoded_path=./data/decoded/split2 
#python3 main.py --model=cnn --action=predict --vid_list_file=./data/test.split2.bundle  --model_save_path=./save_dir/models/cnn2 --results_save_path=./save_dir/results/cnn2 --batch_size=64 --decoded_path=./data/decoded/split2
...
#python3 main.py --model=rnn --action=train --vid_list_file=./data/train.split3.bundle  --model_save_path=./save_dir/models/rnn3 --results_save_path=./save_dir/results/rnn3 --decoded_path=./data/decoded/split3    
#python3 main.py --model=rnn --action=predict  --vid_list_file=./data/test.split3.bundle  --model_save_path=./save_dir/models/rnn3 --results_save_path=./save_dir/results/rnn3 --decoded_path=./data/decoded/split3    
...
#python3 main.py --model=cnn --action=train --vid_list_file=./data/train.split3.bundle --model_save_path=./save_dir/models/cnn3 --results_save_path=./save_dir/results/cnn3 --batch_size=64 --decoded_path=./data/decoded/split3     
#python3 main.py --model=cnn --action=predict --vid_list_file=./data/test.split3.bundle  --model_save_path=./save_dir/models/cnn3 --results_save_path=./save_dir/results/cnn3 --batch_size=64 --decoded_path=./data/decoded/split3
...
#python3 main.py --model=rnn --action=train --vid_list_file=./data/train.split4.bundle  --model_save_path=./save_dir/models/rnn4 --results_save_path=./save_dir/results/rnn4 --decoded_path=./data/decoded/split4 
#python3 main.py --model=rnn --action=predict  --vid_list_file=./data/test.split4.bundle  --model_save_path=./save_dir/models/rnn4 --results_save_path=./save_dir/results/rnn4 --decoded_path=./data/decoded/split4 
...
#python3 main.py --model=cnn --action=train --vid_list_file=./data/train.split4.bundle --model_save_path=./save_dir/models/cnn4 --results_save_path=./save_dir/results/cnn4 --batch_size=64 --decoded_path=./data/decoded/split4
#python3 main.py --model=cnn --action=predict --vid_list_file=./data/test.split4.bundle  --model_save_path=./save_dir/models/cnn4 --results_save_path=./save_dir/results/cnn4 --batch_size=64 --decoded_path=./data/decoded/split4
