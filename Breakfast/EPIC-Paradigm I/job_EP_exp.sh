...
python main.py --model=rnn --To=15 --Ta=15 --action=train --vid_list_file=./data/train.split1.deb.bundle  --model_save_path=./save_dir/models_15_15/rnn1 --results_save_path=./save_dir/results_15_15/rnn1 
